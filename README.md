...
Nosso servidor recebe um conjunto de pares produto e quantidade e retorna o valor total. Caso não tenha o produto no catálogo, uma mensagem irá ser mandada junto ao nome do produto não listado.
